...
export const ArrowRightLeft = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="m2 16 3 3 3-3"/><path d="M2 12V5c0-1.1.9-2 2-2h14"/><path d="m22 8-3-3-3 3"/><path d="M22 12v7c0 1.1-.9 2-2 2H4"/><path d="m7 21-3-3 3-3"/><path d="m17 3 3 3-3 3"/></svg>
);
